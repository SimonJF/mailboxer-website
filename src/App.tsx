    ...
    <div className="d-flex flex-column min-vh-100">
      ...
      <main className="flex-grow-1">
        <Routes>
          ...
          <Route path="/actor-communication-errors/message-type-error/payload-mismatch" element={<PayloadMismatch />} />
          <Route path="/actor-communication-errors/message-type-error/unsupported-request" element={<UnsupportedRequest />} />
          <Route path="/actor-communication-errors/behavioural-type-error/unexpected-request" element={<UnexpectedRequest />} />
          <Route path="/actor-communication-errors/behavioural-type-error/omitted-reply" element={<OmittedReply />} />
