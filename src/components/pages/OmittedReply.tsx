      ...
      <Row className="mb-5">
        <Col>
          ...
          <p className="lead text-center">
            Understanding behavioural type errors when expected responses are not sent
          </p>
        </Col>
      </Row>
      ...
      <Row className="mb-5">
        <Col>
          ...
          <p>
            ...
            Here, the server omits sending <code>{`{id, N}`}</code>, leaving the client blocked indefinitely waiting for a response.
          </p>
